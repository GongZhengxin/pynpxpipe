...
param.recomputeDuplicateSpikes = 1;
...
param.tauR_valuesMin = 1.5/1000; % refractory period time (s), usually 0.0020. 
...
param.tauR_valuesStep = 0.1/1000; % refractory period time (s) steps. Only 
    % used if param.tauR_valuesMin is different from param.tauR_valuesMax
param.tauR_valuesMax = 2.5/1000; % refractory period time (s), usually 0.0020
